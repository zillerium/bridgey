...
/**
 * @title BridgeyPresaleToken (ZILL)
...
contract BridgeyPresaleToken is ERC20, Ownable {
  ...
  string public constant name = "Bridgey Presale Token";
...
/**
 * @title BridgeyPresale
 * BridgeyPresale allows investors to make
 * token purchases and assigns them tokens based
 * on a token per ETH rate. Funds collected are forwarded to a wallet
 * as they arrive.
 */

contract BridgeyPresale is Pausable {
  using SafeMath for uint256;

  BridgeyPresaleToken public token;
